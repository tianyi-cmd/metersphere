<template>
    <div>
<!--      <el-row>-->
<!--        <el-col :span="3" class="script-index">-->
...
<script>
    ...
    export default {
        name: "BeanShellProcessorContent",
      components: {MsDropdown, MsCodeEdit},
      data() {
        return {
          beanShellProcessorData: {},
          codeTemplates: [
            {
      ...
      created() {
        this.beanShellProcessorData = this.beanShellProcessor;
      },
      props: {
        isReadOnly: {
          type: Boolean,
      ...
      methods: {
        addTemplate(template) {
          if (!this.beanShellProcessorData.script) {
            this.beanShellProcessorData.script = "BeanShellProcessorContent";
          }
          this.beanShellProcessorData.script += template.value;
          this.reload();
        },
        reload() {
